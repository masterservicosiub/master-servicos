...
const defaultServices = [
  {
    icon: Search,
    title: "Verificar Vazamento",
    desc: "Detecção e reparo de vazamentos",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: Droplets,
    title: "Instalação Padrão Saneago",
    desc: "Instalação hidráulica padrão",
    gradient: "from-cyan-500 to-sky-500",
  },
  {
    icon: Droplets,
    title: "Limpeza de Caixa d'Água",
    desc: "Higienização completa",
  ...
  {
    icon: Sun,
    title: "Limpeza de Placa Solar",
    desc: "Otimizando sua Geração",
    gradient: "from-orange-500 to-yellow-500",
  },
  {
    icon: Scissors,
    title: "Roçagem de Grama e Mato Alto",
    desc: "Deixe seu jardim sempre lindo",
...
const benefits = [
  {
    ...
    desc: "Todos os serviços com garantia de qualidade e satisfação.",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: Clock,
    title: "Pontualidade",
    desc: "Cumprimos prazos e horários combinados com você.",
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    icon: Award,
    title: "Profissionais Qualificados",
    desc: "Equipe treinada para cada tipo de serviço.",
    ...
    <Zap className="w-5 h-5" /> Serviços Gráficos
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-primary-foreground/90 animate-fade-in-up [animation-delay:480ms]">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4" /> Garantia Total
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4" /> Pontualidade
              </div>
              <div className="flex items-center gap-2">
                <Star className="w-4 h-4 fill-current" /> +500 Clientes
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
              Nossos{" "}
              <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Serviços</span>
            </h2>
                  ...
                  >
                    <div className="aspect-video bg-muted overflow-hidden">
                      {isVideo ? (
                        ...
                        <div
                          className={`w-full h-full bg-gradient-to-br ${gradient} flex items-center justify-center text-white`}
                        >
                    ...
                    <div
                      className={`absolute inset-x-0 top-0 aspect-video bg-gradient-to-br ${gradient} opacity-0 group-hover:opacity-10 transition-opacity pointer-events-none`}
                    />
                    <div className="p-5">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {defaultServices.map((s, i) => (
                ...
                >
                  ...
                  />
                  <div
                    className={`relative w-14 h-14 rounded-xl bg-gradient-to-br ${s.gradient} text-white flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform`}
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {benefits.map((b, i) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${b.gradient} text-white flex items-center justify-center mx-auto mb-4 shadow-lg animate-float`}
                >
          ...
          <div className="max-w-4xl mx-auto bg-card rounded-2xl p-8 md:p-10 border-2 border-accent/40 shadow-2xl flex flex-col md:flex-row items-center gap-6 hover:-translate-y-1 transition-transform animate-fade-in-up">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground">
                Crie sua conta gratuita de Cliente, e tenha desconto automático em todos os serviços, além de acompanhar
                seus pedidos pelo painel do cliente.
              </p>
            </div>
            <Link
              to="/cliente"
